...
contract SIGILS is ERC721Royalty, Ownable(msg.sender) {
    ...
    uint256 public constant HALF_PLEDGE_COST = 2500; // does not include decimals
    ...
    function getHTML(
        ...
        bool guardianStatus = true; // replace with actual check (1M+ pledged and active status)
